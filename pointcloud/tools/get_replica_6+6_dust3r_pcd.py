...
dust3r_model_path = "third_party/checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth"
...
for scene in scenes: 
    path = f"dataset/Replica_6+6/{scene}"
    images = "rgb"
    dataset = "Replica_6+6"
    eval = True
    n_views = 12
    ...
    if demo_setting: 
        ...
        img_dir_for_dust3r = os.path.join("./dust3r_results/Replica__6+6_{}v_thr{}_trimeshsave_minconf1_demosetting/{}".format(n_views, int(dust3r_min_conf_thr), scene))
    else: 
        img_dir_for_dust3r = os.path.join("./dust3r_results/Replica_6+6_{}v_thr{}_trimeshsave_minconf1/{}".format(n_views, int(dust3r_min_conf_thr), scene))
    #breakpoint()
