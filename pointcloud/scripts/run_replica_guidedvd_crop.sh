...
#datasets=('room_1/Sequence_1' 'room_2/Sequence_1' 'office_2/Sequence_2')
#datasets=('office_2_crop_0.6/Sequence_2' 'office_3_crop_0.6/Sequence_1' 'office_4_crop_0.6/Sequence_2')
#datasets=('office_2_crop_0.6/Sequence_2' 'office_2_no_crop/Sequence_2' )
#datasets=('office_3_crop_0.6/Sequence_1' 'office_4_crop_0.6/Sequence_2' 'room_0_crop_0.6/Sequence_2' 'room_1_crop_0.6/Sequence_1' 'room_2_crop_0.6/Sequence_1')
#datasets=('office_2_crop_0.6/Sequence_2' 'office_2_no_crop/Sequence_2')
#datasets=('office_2/Sequence_2' "office_3/Sequence_1" "office_4/Sequence_2")
#datasets=('office_2_crop_0.6/Sequence_2')
### no crop 純複製 ## _2 
#datasets=('office_2_crop_0.6/Sequence_2' 'office_3_crop_0.6/Sequence_1' 'office_4_crop_0.6/Sequence_2' 'room_0_crop_0.6/Sequence_2' 'room_1_crop_0.6/Sequence_1' 'room_2_crop_0.6/Sequence_1')
datasets=('room_2_crop_0.6/Sequence_1')
...
for i in ${!datasets[@]}; do
    dataset="dataset/Replica_crop/${datasets[$i]}"
    workspace=${workspaces[$i]}
    
    echo "Processing dataset: $dataset with workspace: $workspace. "
    
    python train_guidedvd.py --dataset Replica_crop --image "rgb:0|rgb_test:test" \
