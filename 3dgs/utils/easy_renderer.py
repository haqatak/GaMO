...
from gaussian_renderer2 import render_alpha, GaussianModel_tam
...
class EasyRenderer(): 
    def __init__(self, model_path, iteration=10000): 
        ...
        with torch.no_grad(): 
            self.gaussians = GaussianModel_tam(args)
    ...
    def render(self, w2c, intrinsic, h, w): 
        ...
        with torch.no_grad(): 
            ...
            rendering = render_alpha(view, self.gaussians, self.pipeline_param, self.background)
            # [3, H, W]
