...
datasets=('office_2' 'office_3' 'office_4' 'room_0' 'room_1' 'room_2')
...
for i in ${!datasets[@]}; do
    ...
    echo "Processing dataset: $dataset with workspace: $workspace" # rgb:0|rgb_test:test
    
    python train_baseline.py --dataset Replica_6 --image rgb --source_path $dataset --model_path $workspace --eval  --n_views 6 \
